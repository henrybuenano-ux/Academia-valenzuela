...
- ✅ A2 (parcial, 10-jul sesión 2): la red del entorno ya permite academiavalenz.com y api.evolcampus.com (verificado con curl). fathom.video sigue bloqueado (irrelevante ya: transcripciones recibidas por chat).
- ✅ Transcripciones Fathom analizadas (10-jul sesión 2) → `docs/LLAMADAS_FATHOM_HALLAZGOS.md`. Claves: alta automática vía conector oficial confirmada por el cliente; intensivo = pago único con cierre el día del examen (julio); censo EvoCampus 11-jun: 386 alumnos / 119 baja / ~267 activos; hipótesis estacional para P2 (fin de ciclo + campañas paradas) y 3 hipótesis para P1 a contrastar con el censo; campañas de captación de septiembre se preparan en julio–agosto → valorar adelantar E1/D1.
