...
- ✅ P1 CASI RESUELTO con datos reales de EvoCampus: el campus tiene 104 alumnos únicos y **solo 57 activos** (no ~267). Cruce con Woo (59): 38 en ambos, **19 activos sin suscripción Woo** (probablemente intensivos de pago único; uno es la cuenta de la academia), 21 en Woo ya cortados en campus. La brecha "~300 vs 60" no se sostiene. Falta confirmar con Paco de dónde sale el 267 y cómo pagan esos 19. Ver `docs/entregables/censo_evocampus_2026-07-10.md`.
