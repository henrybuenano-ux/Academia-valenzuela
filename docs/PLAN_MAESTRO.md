...
- ✅ Radiografía de facturación en PRODUCCIÓN (10-jul, solo lectura): NO existe ningún plugin/servicio de facturación (31 plugins revisados); cobros por DOS pasarelas activas (Redsys unificada v1.8 + WooPayments v10.8) — el emisor de Fase 2 debe cubrir ambas. VeriFactu (RD 1007/2023): obligación 1-ene-2026 (sociedades) / 1-jul-2026 (autónomos) → plazo YA VENCIDO en cualquier caso: A4 pasa de bloqueante a URGENTE (¿emite la gestoría con su software certificado?).
